...
export function Home(){
  ...
  return (
    ...
    <img src="/img/logo1.svg" className="w-40 "/>
    </header>

    <div className="container max-w-5xl flex-1 p-4 flex flex-col items-center md:flex-row space-y-6 md:space-y0 md:space-x-6">
      
      <div className="md:flex-1 flex justify-center">
        <img src="/img/img.png"className="w-full max-w-md" />
      </div>

          <div className="md:flex-1 flex flex-col space-y-6">  
            <h1 className="text-3xl text-center md:text-left font-bold">Dê o seu palpite e salve-os para a Copa do Mundo do Catar 2022! </h1>
